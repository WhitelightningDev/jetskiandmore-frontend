    ...
    <div className="space-y-4">
      <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="text-sm text-slate-600">Update statuses, send messages, and manage customers.</p>
        </div>
        <div className="flex items-center gap-2 rounded-full border border-slate-200 bg-white px-3 py-2 text-xs text-slate-700 shadow-sm">
          ...
          >
            <SelectTrigger className="h-8 w-40 border-slate-200 bg-white text-slate-900 focus:ring-0">
      ...
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        <Card className="border-slate-200 bg-gradient-to-br from-cyan-50 via-white to-indigo-50 shadow-sm">
          <CardHeader className="pb-2">
            <p className="text-xs uppercase tracking-[0.18em] text-cyan-700">Total</p>
            <CardTitle className="text-lg text-slate-900">All bookings</CardTitle>
          </CardHeader>
          <CardContent className="pt-0 text-3xl font-semibold text-slate-900">{bookings.length}</CardContent>
        </Card>
        <Card className="border-slate-200 bg-white shadow-sm">
          <CardHeader className="pb-2">
            <p className="text-xs uppercase tracking-[0.18em] text-slate-500">Upcoming</p>
            <CardTitle className="text-lg text-slate-900">Future + undated</CardTitle>
          </CardHeader>
          <CardContent className="pt-0 text-3xl font-semibold text-slate-900">{upcomingBookings.length}</CardContent>
        </Card>
        <Card className="border-slate-200 bg-white shadow-sm">
          <CardHeader className="pb-2">
            <p className="text-xs uppercase tracking-[0.18em] text-slate-500">Past</p>
            <CardTitle className="text-lg text-slate-900">Completed rides</CardTitle>
          </CardHeader>
          <CardContent className="pt-0 text-3xl font-semibold text-slate-900">{pastBookings.length}</CardContent>
        </Card>
        <Card className="border-slate-200 bg-white shadow-sm">
          <CardHeader className="pb-2">
            <p className="text-xs uppercase tracking-[0.18em] text-slate-500">Filter</p>
            <CardTitle className="text-lg text-slate-900">Showing</CardTitle>
          </CardHeader>
          <CardContent className="pt-0 text-lg text-slate-900">
                      ...
                      return (
                        <TableRow key={`${section.key}-${b.id}`}>
                          ...
                          <TableCell>
                            <Badge
                              variant="outline"
                              className="border-slate-200 bg-slate-50 text-xs font-semibold text-slate-800"
                            >
                              {timeLabel}
                            </Badge>
                          </TableCell>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="mt-2 flex flex-col gap-1">
                        <p className="text-sm font-semibold text-slate-900">{b.rideId}</p>
                        <p className="text-xs text-slate-500">{b.addons ? 'With add-ons' : 'Standard ride'}</p>
                        <p className="mt-1 text-sm font-medium text-slate-900">{b.fullName}</p>
